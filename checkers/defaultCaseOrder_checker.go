...
func (c *defaultCaseOrderChecker) VisitStmt(stmt ast.Stmt) { _ = "STUB: not implemented"; return }

// is `default` case

func (c *defaultCaseOrderChecker) warn(cause *ast.CaseClause) { _ = "STUB: not implemented"; return }
